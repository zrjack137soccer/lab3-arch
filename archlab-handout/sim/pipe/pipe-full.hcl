...
# 1. I implemented iaddq to fetch instructions to make it valid, make it work for regid bytes and words. 
# 2. I implemented iaddq to decode instructions: B source and E destination.
# 3. I implemented iaddq to execture instructions: E_icode in for valB and for valC and for setcc to set the condition
#    codes for iaddq.
#/* $begin pipe-all-hcl */
####################################################################
